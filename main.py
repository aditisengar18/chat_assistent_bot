...
st.sidebar.write("""
    ...
    - "List all employees hired after [YYYY-MM-DD]."
    - "Show the highest-paid employee."
    - "What is the total salary expense for the [Department]?"
""")
...
def process_query(query):
    ...
    if "Show me all employees in the" in query:
        ...
        return f"The total salary expense for **{department}** is **${result[0][0]:,.2f}**." if result and result[0][0] else f"No salary data found for the **{department}** department."
